...
def models(r, model):
	...
	rho, vsh, vsv, vph, vpv, eta = models(r, model)
	"""
...
def model_onelayer(r):
	...
	return rho, vsh, vsv, vph, vpv, eta
...
def model_prem(r):
	...
	a radius r in km. The reference frequency is 1 Hz. Crust continued into the ocean.
	"""
